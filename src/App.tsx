    ...
    <>
      <section>
        ...
        <button 
          ...
          className="fixed bottom-5 left-1/2 -translate-x-1/2 bg-black/90 backdrop-blur-md p-2 rounded-md hover:bg-black transition duration-200 cursor-pointer w-10 h-10 flex items-center justify-center overflow-hidden"
        >
